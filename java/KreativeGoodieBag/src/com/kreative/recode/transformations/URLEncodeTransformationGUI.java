...
public class URLEncodeTransformationGUI extends JPanel implements TextTransformationGUI {
	private static final long serialVersionUID = 1L;
	
	private final EncodingListPanel encoding;
	
	public URLEncodeTransformationGUI(String encoding) {
	...
	public TextTransformation createTransformation() {
		return new URLEncodeTransformation(encoding.getEncoding());
	}
}
