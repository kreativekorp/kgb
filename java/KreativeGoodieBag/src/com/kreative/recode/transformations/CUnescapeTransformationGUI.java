...
public class CUnescapeTransformationGUI extends JPanel implements TextTransformationGUI {
	private static final long serialVersionUID = 1L;
	
	private final boolean ignoreASCII;
	private final EncodingListPanel encoding;
	
	public CUnescapeTransformationGUI(boolean ignoreASCII, String encoding) {
	...
	public TextTransformation createTransformation() {
		return new CUnescapeTransformation(ignoreASCII, encoding.getEncoding());
	}
}
